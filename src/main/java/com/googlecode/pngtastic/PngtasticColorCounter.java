...
public class PngtasticColorCounter {
	...
	private static final String HELP = "java -jar pngtastic-x.x.jar com.googlecode.pngtastic.PngtasticColorCounter [options] file1 [file2 ..]\n"
			...
			+ "  --fileSuffix       string appended to the optimized files (file.png becomes file.png.optimized.png)\n"
	...
	/** */
	public PngtasticColorCounter(String toDir, String[] fileNames, String logLevel, double distThreshold,
			double freqThreshold, int minAlpha) {
	...
	public static void main(String[] args) {
		...
		new PngtasticColorCounter(toDir, files, logLevel, distThreshold, freqThreshold, minAlpha);
	}
